...
public class AlumnoGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ing. Mecatrónica", "Ing. en Sistemas Comp.", "Ing. en Alimentos", "Ing. Ambiental", "Ing. Metalúrgica" }));

        jLabel5.setText("Unidad Académica: ");

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "UPIIZ", "CECyT18" }));
